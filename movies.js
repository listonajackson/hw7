...
firebase.auth().onAuthStateChanged(async function(user) {
  if (user) {
    ...
    <div class="text-white text-center text-xl font-bold mt-4 px-4 py-2 rounded">Signed in as ${user.displayName}
  ...
  let apiKey = '64b336603289beb29503a81cc44e6dae'
  ...
  for (let i=0; i<movies.length; i++) {
    ...
    // document.querySelector('sign-').classList.add('Sign in As Liston')
